                        ...
                        <!-- Task Name -->
                            <div class="mb-3">
                                <label for="task_name" class="form-label">Task Name</label>
                                    <input type="text" class="form-control @error('task_name') is-invalid @enderror" id="task_name" name="task_name" value="{{ old('task_name', $task->task_name) }}" placeholder="Enter task name">
                                @error('task_name')
                            ...
                            <div class="mb-3">
                                <label for="task_description" class="form-label">Task Description</label>
                                    <textarea class="form-control @error('task_description') is-invalid @enderror" id="task_description" name="task_description" rows="4" placeholder="Enter task description">{{ old('task_description', $task->task_description) }}</textarea>
                            ...
                            <div class="mb-3">
                                <label for="task_start_date" class="form-label">Task Start Date</label>
                                    <input type="date" class="form-control @error('task_start_date') is-invalid @enderror" id="task_start_date" name="task_start_date" value="{{ old('task_start_date', $task->task_start_date) }}">
                            ...
                            <div class="mb-3">
                                <label for="task_end_date" class="form-label">Task End Date</label>
                                    <input type="date" class="form-control @error('task_end_date') is-invalid @enderror" id="task_end_date" name="task_end_date" value="{{ old('task_end_date', $task->task_end_date) }}">
                                @error('task_end_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
