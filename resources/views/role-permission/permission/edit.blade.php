            ...
            <div class="px-3">
                ...
                <div class="container-fluid">
                    ...
                    <div class="py-3 py-lg-4">
                        <div class="row">
                            <div class="col-lg-6">
                                <h4 class="page-title mb-0">Edit Permissions</h4>
                            </div>
                            <div class="col-lg-6">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title mb-3">Edit Permission</h4>
                                    <!-- Add error message containers under each input field -->
                                    <form id="userForm" role="form" method="post" action="{{ url('permissions/' . $permission->id) }}">
                                        @csrf
                                        @method('PUT')
                                        <div class="row mb-3">
                                            <label for="name" class="col-sm-3 col-form-label">Name</label>
                                            <div class="col-sm-9">
                                                <input type="name" class="form-control" name="name" id="name" value="{{$permission->name}}">
